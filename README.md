...
- پنل ترمینالی لینوکس با اجرای `sudo aval-bot-menu` برای کنترل سرویس‌ها، لاگ‌ها، تنظیمات، آپدیت و بک‌آپ
- ویرایش محصول/Config ساخته‌شده از داخل پنل تلگرام و Web Panel، بدون تغییر سفارش‌های قبلی
